...
namespace babrat {
    ...
    namespace container {
        ...
        /**
          * @brief Abstract class for sorted associative container implementations.
          *
          ...
          *
          * @details This class defines the interface for sorted tree-based containers,
          * combining functionality from AssociativeContainer and Serializable interfaces.
          * Implementations should maintain elements in sorted order according to key comparison.
          */
