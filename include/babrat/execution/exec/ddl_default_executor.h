...
public:
    ...
    DdlCommandResult executeCreateTable(const CreateTableCommand& createTableCommand [[maybe_unused]]) override {
       */
...
*//*
    ...
    DdlCommandResult executeDropStatement(const DropStatementCommand& dropStatementCommand [[maybe_unused]]) override {
