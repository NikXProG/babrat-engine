...
#ifndef BABRAT_TABLE_ELEMENTS_H
#define BABRAT_TABLE_ELEMENTS_H
...
public:
    ...
    static ColumnDefinitionCollection create(std::vector<ColumnDefinition> columnDefinitions) {
        return ColumnDefinitionCollection(std::move(columnDefinitions));
    }

    template<typename... Args>
    static ColumnDefinitionCollection create(Args&&... args) {
