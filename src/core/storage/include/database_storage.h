...
#include "database_wal_manager.h"
...
/*
         ...
         public:
             ...
             explicit DatabaseStorage(const DatabaseOptions &options = {})
                     : m_options(options) {
                 ...
                 if (m_options.mode == DatabaseMode::in_memory){
                    m_storageContainer = std::make_unique<
                     ...
                     throw not_implemented("construct database_storage",
                                           "file system mode is not implemented yet");
                 }
         ...
         public:
             ...
             std::vector<Value> disposeBatch(
                 ...
                 auto value = m_storageContainer->disposeBatch(
                         pool_name,
                         schema_name,
                         collection_name,
                         items);
                     ...
                     try{
                         ...
                         m_wal->write( ++m_indexWal,
                                      WALMask{
                                              ...
                                              .encode());
                     } catch(wal::boundary_index_error){}
