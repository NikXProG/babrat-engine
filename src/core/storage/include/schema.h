...
namespace babrat {
    ...
    namespace storage {
        ...
        private:
            ...
            {
                collections_ =
                        TreeFactory::copyTree<FlyString, collection, StringCompare>(
                                other.collections_,
            ...
            {
                collections_ =
                        TreeFactory::moveTree<FlyString, collection, StringCompare>(
                                other.collections_,
                                variant_ = other.variant_);
        ...
        public:
            ...
            size_t deserialize(std::istream& stream) override {
                ...
                if (!collections_) {
                    collections_ =
                            TreeFactory::create<FlyString,collection,StringCompare>(variant);
                }
