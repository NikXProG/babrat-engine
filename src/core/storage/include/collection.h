    ...
    namespace storage {
        ...
        public:
            ...
            size_t deserialize(std::istream& stream) override {
                ...
                data_ = TreeFactory::create<Key, Value, key_compare>(variant);
        ...
        private:
            ...
            {
                data_ = TreeFactory::copyTree<Key, Value, key_compare>(
                        other.data_,
            ...
            void move_from(
                    collection &&other)
            {
                data_ = TreeFactory::moveTree<Key, Value, key_compare>(
                        other.data_,
                        variant_ = other.variant_);
            }
