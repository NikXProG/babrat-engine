    ...
    namespace storage {
        ...
        public:
            ...
            size_t deserialize(std::istream& stream) override {
                ...
                if (!schemas_) {
                    schemas_ =
                            TreeFactory::create<FlyString,schema,StringCompare>(variant_);
                }
        ...
        public:
            ...
            explicit pool(SearchTreeVariant variant = SearchTreeVariant::b_plus) : variant_(variant) {
                schemas_ = TreeFactory::create<FlyString,schema,StringCompare>(variant);
            }
        ...
        private:
            ...
            void copy_from(
                    pool const &other)
            {
                schemas_ = TreeFactory::copyTree<FlyString,schema, StringCompare>(
                        other.schemas_,
            ...
            void move_from(
                    pool &&other)
            {
                schemas_ = TreeFactory::moveTree<FlyString,schema,StringCompare>(
                        other.schemas_,
                        variant_ = other.variant_);
            }
