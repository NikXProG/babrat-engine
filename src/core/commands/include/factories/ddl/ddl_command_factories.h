...
#ifndef BABRAT_DDL_COMMAND_FACTORIES_H
#define BABRAT_DDL_COMMAND_FACTORIES_H

#include "drop_statement_factory.h"
#include "create_table_factory.h"
#include "ddl_command_factory.h"
#include <typeindex>
...
public:
    ...
    std::unique_ptr<IDdlCommand> create(const IDdlStatement& statement) override{
        ...
        throw std::runtime_error(
                "Unable to find ddl command factory for statement. Valid statements: " +
