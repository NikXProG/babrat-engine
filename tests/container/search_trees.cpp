...
TYPED_TEST(SearchTreeTest, InsertAndSearchWorks) {
    ...
    EXPECT_THROW(this->tree_->search(1001), babrat::ContainerException);
...
TYPED_TEST(SearchTreeTest, UpdateModifiesExistingValues) {
    ...
    EXPECT_THROW(this->tree_->update(3, 300),   babrat::ContainerException);
}
...
TYPED_TEST(EmptyTreeTest, OperationsOnEmptyTreeThrowExceptions) {
    ...
    EXPECT_THROW(this->tree_->search(1), babrat::ContainerException);
    EXPECT_THROW(this->tree_->remove(1),  babrat::ContainerException);
